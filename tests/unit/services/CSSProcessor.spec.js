...
describe("ClassProcessor", () => {
  ...
  it("styles all rows", () => {
    ...
    expect(processor.processedClasses[0].rows).toEqual([0, 1, 2, 3, 4]);
  ...
  it("styles odd rows", () => {
    ...
    expect(processor.processedClasses[0].rows).toEqual([1, 3]);
  });
  ...
  it("styles even rows", () => {
    ...
    expect(processor.processedClasses[0].rows).toEqual([0, 2, 4]);
  });
  ...
  it("styles a specific row range", () => {
    ...
    expect(processor.processedClasses[0].rows).toEqual([1, 2, 3]);
  });
  ...
  it("styles a some rows", () => {
    ...
    expect(processor.processedClasses[0].rows).toEqual([1, 4]);
  });
