  ...
  computed: {
    ...
    cellClasses() {
      return Object.assign(
        ...
        this.cssProcessor.processFixed(
          this.row._classes,
          this.columnIndex,
          this.row,
          this.column
    ...
    clickEvents() {
      return this.hasCollapseIcon ? this.toggleChildren : {};
    },
  },
  ...
  methods: {
    value(h) {
      ...
      if (this.columnSlot) {
        ...
        Object.prototype.hasOwnProperty.call(this.row, this.column.property)
      ) {
