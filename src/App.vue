<template>
  <div id="app">
    ...
    >
      ...
      <template v-slot:name_tiger="props"
        >test cell - {{ props.row.name }}</template
      >
      <!-- Will be applied on the city column -->
      <template v-slot:city="props"
        >test column - {{ props.row.name }}</template
      >
      <!-- Will be applied on the row with _id tiger -->
      <template v-slot:_tiger="props">test row - {{ props.row.name }}</template>
      <template v-slot:no-rows>No results</template>
